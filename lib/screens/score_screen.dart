            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                      "You get +${(_qnController.correctAns / (_qnController.questions.length + 1) * 100).toInt()} Quiz Points")
                ],
              ),
            ),
            SizedBox(
            ...
            Row(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    _qnController.correctAns.toString() + " question",
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    "${(_qnController.correctAns / (_qnController.questions.length + 1) * 100).toInt()}%",
                    style: Theme.of(context).textTheme.labelMedium,
                  ),
                ])
              ],
            ...
            Row(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    countTypeAnswerOccurrences(
                            _qnController.answersType, AnswerType.Skip)
                        .toString(),
                    style: Theme.of(context).textTheme.labelMedium,
                  ),
                ]),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    countTypeAnswerOccurrences(
                            _qnController.answersType, AnswerType.False)
                        .toString(),
                    style: Theme.of(context).textTheme.labelMedium,
                  ),
                ])
